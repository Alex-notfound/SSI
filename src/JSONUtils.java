...
public class JSONUtils {
	...
	public static final void main(String[] args) {
		...
		/*
		 * OJO: System.console() no funciona desde los IDEs (desde linea de comandos no
		 * hay problema) String nombre = System.console().readLine("Nombre : ");
		 * datos.put("nombre", nombre); String fecha =
		 * System.console().readLine("Fecha  : "); datos.put("fecha", fecha); String
		 * lugar = System.console().readLine("Lugar  : "); datos.put("lugar", lugar);
		 */
